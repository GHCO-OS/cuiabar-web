...
Descadastrar: {{unsubscribe_url}}`,
  ...
  createPreset({
    ...
    heroImage: '/burguer/burger-cuiabar-hero.webp',
    heroAlt: 'Burger do Burger Cuiabar em destaque',
    ...
    spotlights: [
      {
        ...
        alt: 'Burger O Cuiabar do Burger Cuiabar',
      },
      {
        label: 'Canal oficial',
        ...
        alt: 'Burger O Colosso do Burger Cuiabar',
      },
    ],
